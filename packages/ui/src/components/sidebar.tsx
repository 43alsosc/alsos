...
import { useIsMobile } from "@alsos/ui/hooks/use-mobile"
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@alsos/ui/components/sheet"
import { Skeleton } from "@alsos/ui/components/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@alsos/ui/components/tooltip"
...
function Sidebar({
  ...
  /** When `none`, the fixed desktop sidebar is hidden; the mobile sheet still works below the md breakpoint. */
  desktopVisibility?: "default" | "none"
}) {
